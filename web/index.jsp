...
<script type="application/javascript">
    ...
    function validateAdmin() {
        ...
        if (user == "admin@rmd.ac.in") {
            location.href = "login.jsp?pass=" + pass;
            s
        }
    ...
    <div class="lockscreen-item">
        ...
        <form class="lockscreen-credentials">
            <div class="input-group">
                <input type="text" class="form-control" id="register" onkeypress="return key(event)" autocomplete="off"
                       name="register" placeholder="Register Number">

                <div class="input-group-btn">
                    <button type="button" id="button" name="submit" onclick="checkStudent()" class="btn"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box box-primary">
                    ...
                    <input class="form-control" onkeypress="return keyLogin(event)" autofocus type="password"
