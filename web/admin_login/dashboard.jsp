...
<head>
    ...
    <script type="application/javascript">
        ...
        function deactivateLink() {
            ...
            window.location.href = "DashboardServlet?crud=deactivate";
                    ...
                    <div class="box-body box-padding">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="createYear"
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal">
                                ...
                                <button type="button" class="btn btn-success pull-right" data-toggle="modal"
                                        data-target="#modal-success">Insert
                                </button>
                    ...
                    <div class="box-body box-padding">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal">
                                ...
                                <button type="button" onclick="Tdelete()" class="btn btn-danger pull-right">Delete
                                </button>
                ...
                <div class="box-body ">
                    <div class="alert " style="background-color:#F0F0F0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control select2" style="" id="publishyear"
                                        data-placeholder="Select Year" required>
                            ...
                            <div class="col-sm-5">
                                <select class="form-control select2" style="" id="publishsem"
                            ...
                            <div>
                                <button type="button" class="btn bg-purple " onclick="publishlink()"><i
            ...
            <div class="modal-content">
                ...
                <form action="DashboardServlet" method="post" enctype="multipart/form-data" id="insertform">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <select class="select2" required style="width:300px;" id="selectsem" name="sem"
                                        data-placeholder="Please Select Semester">
    ...
    <div class="modal modal-danger fade" id="modal-danger">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>This will deactivate the published link.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-outline" onclick="deactivateLink()">Ok</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
